    ...
    <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="space-y-4">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold tracking-tight text-white border-b border-glassBorder pb-4">
          {t('nav', 'social_cultural')}
        </h1>
        <p className="text-textSecondary max-w-3xl leading-relaxed mt-4">
          {language === 'es'
            ? 'Análisis de los factores sociales y culturales que influyen en el mercado objetivo.'
            : 'Analysis of social and cultural factors influencing the target market.'}
        </p>
      </header>
