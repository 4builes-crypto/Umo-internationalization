...
import { SelectedState } from './pages/SelectedState';
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="selected-state" element={<SelectedState />} />
        <Route path="international-strategy" element={<InternationalStrategy />} />
